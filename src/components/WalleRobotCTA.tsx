  ...
  return (
    <div className="relative flex items-end gap-3">
      ...
      <motion.div
        ...
        className="relative bg-white rounded-2xl shadow-lg px-5 py-3 mb-8 border-2 border-emerald-200"
      >
        <div className="flex items-center gap-2">
          <span className="text-2xl">🚀</span>
          <p className="text-sm text-gray-700 whitespace-nowrap">
            <span className="font-semibold text-emerald-700">Get started in seconds!</span>
          </p>
        </div>
        {/* Speech bubble tail */}
        <div 
